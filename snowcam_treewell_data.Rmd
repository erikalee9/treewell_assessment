...
# Scatterplot
persb_cumTreeTemp_corr_plot_accu <- ggplot(persb_corr_data_accu, aes(x = cum_daily_tree_temp, y = well_diam, color = factor(tree_id))) +
  geom_point(aes(shape = burn_status), size = 2, alpha = 0.7) + 
  geom_smooth(method = "lm", color = "grey", se = TRUE) +
  facet_wrap(~ tree_id) +  # Separate by tree_id
  labs(
...
p_totalcumTreeTemp_r2_values_accu <- persb_corr_data_accu %>%
  drop_na(well_diam, totalcum_treetemp) %>%
  group_by(tree_id) %>%
  summarize(
    cor_test = list(cor.test(well_diam, totalcum_treetemp, use = "complete.obs")),
    .groups = "drop"
  ) %>%
   mutate(
    R2 = map_dbl(cor_test, ~ .x$estimate^2),  # Extract R²
...
# Scatterplot
persb_totalcumTreeTemp_corr_plot_accu <- ggplot(persb_corr_data_accu, aes(x = totalcum_treetemp, y = well_diam, color = factor(tree_id))) +
  geom_point(aes(shape = burn_status), size = 2, alpha = 0.7) + 
  geom_smooth(method = "lm", color = "grey", se = TRUE) +
...
# Scatterplot
persb_totalcumTreeTemp_corr_plot_abla <- ggplot(persb_corr_data_abla, aes(x = totalcum_treetemp, y = well_diam, color = factor(tree_id))) +
  geom_point(aes(shape = burn_status), size = 2, alpha = 0.7) + 
  geom_smooth(method = "lm", color = "grey", se = TRUE) +
  facet_wrap(~ tree_id, nrow = 1) +  # Separate by tree_id
  labs(
...
p_totalcumNR_r2_values_accu <- persb_corr_data_accu %>%
  drop_na(well_diam, totalcum_NR) %>%  # Remove rows where either column is NA
  group_by(tree_id) %>%
  summarize(
    cor_test = list(cor.test(well_diam, totalcum_NR, use = "complete.obs")),
    .groups = "drop"
  ) %>%
  mutate(
    R2 = map_dbl(cor_test, ~ .x$estimate^2),  # Extract R²
...
# Scatterplot
persb_totalcumNR_corr_plot_accu <- ggplot(persb_corr_data_accu, aes(x = totalcum_NR, y = well_diam, color = factor(tree_id))) +
  geom_point(aes(shape = burn_status), size = 2, alpha = 0.7) + 
  geom_smooth(method = "lm", color = "grey", se = TRUE) +
  facet_wrap(~ tree_id, nrow = 1) +  # Separate by tree_id
  labs(
...
# Scatterplot
persb_totalcumNR_corr_plot_abla <- ggplot(persb_corr_data_abla, aes(x = totalcum_NR, y = well_diam, color = factor(tree_id))) +
  geom_point(aes(shape = burn_status), size = 2, alpha = 0.7) + 
  geom_smooth(method = "lm", color = "grey", se = TRUE) +
  facet_wrap(~ tree_id, nrow = 1) +  # Separate by tree_id
  labs(
...
# Scatterplot
transb_totalcumTreeTemp_corr_plot_accu <- ggplot(transb_corr_data_accu, aes(x = totalcum_treetemp, y = well_diam, color = factor(tree_id))) +
  geom_point(aes(shape = burn_status), size = 2, alpha = 0.7) + 
  geom_smooth(method = "lm", color = "grey", se = TRUE) +
  facet_wrap(~ tree_id, nrow = 1) +  # Separate by tree_id
  labs(
...
# Scatterplot
transb_totalcumTreeTemp_corr_plot_abla <- ggplot(transb_corr_data_abla, aes(x = totalcum_treetemp, y = well_diam, color = factor(tree_id))) +
  geom_point(aes(shape = burn_status), size = 2, alpha = 0.7) + 
  geom_smooth(method = "lm", color = "grey", se = TRUE) +
  facet_wrap(~ tree_id, nrow = 1) +  # Separate by tree_id
  labs(
...
```{r}
TSZ_totalcum_TreeTemp <- ggarrange(transb_totalcumTreeTemp_corr_plot_accu, transb_totalcumTreeTemp_corr_plot_abla, nrow = 2, ncol = 1, common.legend = TRUE, legend = "none")
...
# Scatterplot
transb_totalcumNR_corr_plot_accu <- ggplot(transb_corr_data_accu, aes(x = totalcum_NR, y = well_diam, color = factor(tree_id))) +
  geom_point(aes(shape = burn_status), size = 2, alpha = 0.7) + 
  geom_smooth(method = "lm", color = "grey", se = TRUE) +
  facet_wrap(~ tree_id, nrow = 1) +  # Separate by tree_id
  labs(
...
# Scatterplot
transb_totalcumNR_corr_plot_abla <- ggplot(transb_corr_data_abla, aes(x = totalcum_NR, y = well_diam, color = factor(tree_id))) +
  geom_point(aes(shape = burn_status), size = 2, alpha = 0.7) + 
  geom_smooth(method = "lm", color = "grey", se = TRUE) +
  facet_wrap(~ tree_id, nrow = 1) +  # Separate by tree_id
  labs(
...
```{r}
TSZ_totalcum_NR <- ggarrange(transb_totalcumNR_corr_plot_accu, transb_totalcumNR_corr_plot_abla, nrow = 2, ncol = 1, common.legend = TRUE, legend = "none")
...
```{r}
#Tree Temp
comb_corr_treetemp <- ggarrange(PSZ_totalcum_TreeTemp, TSZ_totalcum_TreeTemp, nrow = 2, ncol = 1, common.legend = TRUE, legend = "none")
...
persb_vol_SWE_fullseason_lineplot <- ggplot() + 
  ...
  geom_vline(xintercept = as.Date('2024-05-06'), color = "grey23", linetype = "dashed", linewidth = 0.6, alpha = 0.8) +
  geom_line(data = fullseason_vol_persb, aes(x = date, y = vol_sensor_m3, color = "open area", linetype = "open area"), linewidth = 1, alpha = 0.8) + 
  geom_line(data = persb_col_tree1, aes(x = date, y = vol_tree_m3, color = "tree 1", linetype = "tree 1"), linewidth = 1, alpha = 0.8) + 
  geom_line(data = persb_col_tree2, aes(x = date, y = vol_tree_m3, color = "tree 2", linetype = "tree 2"), linewidth = 1, alpha = 0.8) + 
  geom_line(data = persb_col_tree3, aes(x = date, y = vol_tree_m3, color = "tree 3", linetype = "tree 3"), linewidth = 1, alpha = 0.8) +
  geom_line(data = persb_col_tree4, aes(x = date, y = vol_tree_m3, color = "tree 4", linetype = "tree 4"), linewidth = 1, alpha = 0.8) +  
...
persb_vol_SWE_abla_lineplot <- ggplot() +
  geom_line(data = vol_persb_corr_data_abla, aes(x = date, y = vol_sensor_m3, color = "open area", linetype = "open area"), linewidth = 1, alpha = 0.8) + 
  geom_line(data = persb_col_tree1_abla, aes(x = date, y = vol_tree_m3, color = "tree 1", linetype = "tree 1"), linewidth = 1, alpha = 0.8) + 
  geom_line(data = persb_col_tree2_abla, aes(x = date, y = vol_tree_m3, color = "tree 2", linetype = "tree 2"), linewidth = 1, alpha = 0.8) + 
  geom_line(data = persb_col_tree3_abla, aes(x = date, y = vol_tree_m3, color = "tree 3", linetype = "tree 3"), linewidth = 1, alpha = 0.8) +
  geom_line(data = persb_col_tree4_abla, aes(x = date, y = vol_tree_m3, color = "tree 4", linetype = "tree 4"), linewidth = 1, alpha = 0.8) +  # Only tree 4 has dashed line
...
transb_vol_SWE_fullseason_lineplot <- ggplot() + 
  # Line denoting ablation season
  geom_vline(xintercept = as.Date('2024-04-01'), color = "grey23", linetype = "dashed", linewidth = 0.6, alpha = 0.8) +
  geom_line(data = fullseason_vol_transb, aes(x = date, y = vol_sensor_m3, color = "open area", linetype = "open area"), linewidth = 1, alpha = 0.8) + 
  geom_line(data = transb_col_tree1, aes(x = date, y = vol_tree_m3, color = "tree 1", linetype = "tree 1"), linewidth = 1, alpha = 0.8) + 
  geom_line(data = transb_col_tree2, aes(x = date, y = vol_tree_m3, color = "tree 2", linetype = "tree 2"), linewidth = 1, alpha = 0.8) + 
  geom_line(data = transb_col_tree3, aes(x = date, y = vol_tree_m3, color = "tree 3", linetype = "tree 3"), linewidth = 1, alpha = 0.8) +
  geom_line(data = transb_col_tree4, aes(x = date, y = vol_tree_m3, color = "tree 4", linetype = "tree 4"), linewidth = 1, alpha = 0.8) +  
...
transb_vol_SWE_abla_lineplot <- ggplot() +
  geom_line(data = vol_transb_corr_data_abla, aes(x = date, y = vol_sensor_m3, color = "open area", linetype = "open area"), linewidth = 1, alpha = 0.8) + 
  geom_line(data = transb_col_tree1_abla, aes(x = date, y = vol_tree_m3, color = "tree 1", linetype = "tree 1"), linewidth = 1, alpha = 0.8) + 
  geom_line(data = transb_col_tree2_abla, aes(x = date, y = vol_tree_m3, color = "tree 2", linetype = "tree 2"), linewidth = 1, alpha = 0.8) + 
  geom_line(data = transb_col_tree3_abla, aes(x = date, y = vol_tree_m3, color = "tree 3", linetype = "tree 3"), linewidth = 1, alpha = 0.8) +
  geom_line(data = transb_col_tree4_abla, aes(x = date, y = vol_tree_m3, color = "tree 4", linetype = "tree 4"), linewidth = 1, alpha = 0.8) +  # Only tree 4 has dashed line
...
```{r}
comb_fullseason_SWEvol <- ggarrange(persb_vol_SWE_fullseason_lineplot, transb_vol_SWE_fullseason_lineplot, nrow = 2, ncol = 1, common.legend = TRUE, legend = "right")
...
comb_abla_SWEvol <- ggarrange(persb_vol_SWE_abla_lineplot, transb_vol_SWE_abla_lineplot, nrow = 2, ncol = 1, common.legend = TRUE, legend = "right")
