...
persb_NR_corr_plot <- ggplot(persb_corr_long, aes(x = NR_Avg, y = well_diam_diff, color = tree_id)) +
  ...
  theme_bw() +
  geom_text(data = p_NR_r2_values, aes(x = Inf, y = Inf, label = R2_label), 
            hjust = 1.1, vjust = 1.5, inherit.aes = FALSE, size = 5)
...
# Scatterplot with facet_wrap
persb_SD_corr_plot <- ggplot(persb_corr_long, aes(x = maximum_depth_cm, y = well_diam_diff, color = tree_id)) +
  geom_point() +  # Scatter points
  geom_smooth(method = "lm", color = "black", se = FALSE) +  # Trendline
  facet_wrap(~ tree_id) +  # Separate by tree_id
  labs(
...
```{r}
# Tree Temp Cggsave("transb_SD_corr_plot.png", plot = persb_SD_corr_plot, dpi = 600)orrelation
# Compute R^2 for each tree_id
...
transb_NetSW_corr_plot <- ggplot(transb_corr_long, aes(x = SWnet_Avg, y = well_diam_diff, color = tree_id)) +
  ...
  theme_bw() +
  geom_text(data = t_NetSW_r2_values, aes(x = Inf, y = Inf, label = R2_label), 
            hjust = 1.1, vjust = 1.5, inherit.aes = FALSE, size = 5)
...
transb_NetLW_corr_plot <- ggplot(transb_corr_long, aes(x = LWnet_Avg, y = well_diam_diff, color = tree_id)) +
  ...
  theme_bw() +
  geom_text(data = t_NetLW_r2_values, aes(x = Inf, y = Inf, label = R2_label), 
            hjust = 1.1, vjust = 1.5, inherit.aes = FALSE, size = 5)
...
transb_NR_corr_plot <- ggplot(transb_corr_long, aes(x = NR_Avg, y = well_diam_diff, color = tree_id)) +
  ...
  theme_bw() +
  geom_text(data = t_NR_r2_values, aes(x = Inf, y = Inf, label = R2_label), 
            hjust = 1.1, vjust = 1.5, inherit.aes = FALSE, size = 5)
...
transb_SD_corr_plot <- ggplot(transb_corr_long, aes(x = maximum_depth_cm, y = well_diam_diff, color = tree_id)) +
  ...
  theme_bw() +
  geom_text(data = t_SD_r2_values, aes(x = Inf, y = Inf, label = R2_label), 
            hjust = 1.1, vjust = 1.5, inherit.aes = FALSE, size = 5)
...
```{r}
ggsave("persb_TreeTemp_corr_plot_accu.png", plot = persb_AirTC_corr_plot_accu, dpi = 600)
```
...
```{r}
ggsave("persb_TreeTemp_corr_plot_abla.png", plot = persb_AirTC_corr_plot_abla, dpi = 600)
```
