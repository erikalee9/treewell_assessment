...
vol_transb_corr_data_accu <- transb_corr_data_accu %>%
  ...
  mutate(rad_treewell_cm2 = well_diam/2, 
         ...
         #creating the volume of the snow under sensor
         #vol_sensor_cm3 = pi * rad_cylinder_cm2^2 * SnowDepth_cm, 
         vol_sensor_cm3 = pi* rad_cylinder_cm2^2*maximum_depth_cm, 
         #converting volumne to m^3
         vol_sensor_m3 = vol_sensor_cm3/1e6,
         vol_tree_m3 = vol_tree_cm3/1e6)
```
...
transb_vol_SWE_accu_lineplot <- ggplot() +
  geom_line(data = vol_transb_corr_data_accu, aes(x = date, y = vol_sensor_cm3, color = "Sensor Volume", linetype = burn_status), linewidth = 1, alpha = 0.7) + 
  geom_line(data = transb_col_tree1_accu, aes(x = date, y = vol_sensor_cm3, color = "tree 1", linetype = burn_status), linewidth = 1, alpha = 0.7) + 
  geom_line(data = transb_col_tree2_accu, aes(x = date, y = vol_tree_cm3, color = "tree 2", linetype = burn_status), linewidth = 1, alpha = 0.7) + 
  geom_line(data = transb_col_tree3_accu, aes(x = date, y = vol_tree_cm3, color = "tree 3", linetype = burn_status), linewidth = 1, alpha = 0.7) +
  geom_line(data = transb_col_tree4_accu, aes(x = date, y = vol_tree_cm3, color = "tree 4", linetype = burn_status), linewidth = 1, alpha = 0.7) +
  #facet_wrap(~ tree_id, nrow = 1, ncol = 4) +  # Separate by tree_id
  labs(
    title = "a) TSZ Accumulation",
    x = "Date",
  ...
  theme_bw() +
  scale_color_manual(values = c("Sensor Volume" = "blue", "tree 1" = "red", "tree 2" = "green", "tree 3" = "purple", "tree 4" = "black")) +
  scale_linetype_manual(values = c("GB" = "solid", "DB" = "dashed")) +  # Custom linetypes
  guides(color = guide_legend(title = "Volume Type"), linetype = guide_legend(title = "Burn Status"))
...
transb_vol_SWE_abla_lineplot <- ggplot() +
  geom_line(data = vol_transb_corr_data_abla, aes(x = date, y = vol_sensor_cm3, color = "Sensor Volume", linetype = burn_status), linewidth = 1, alpha = 0.7) + 
  geom_line(data = transb_col_tree1_abla, aes(x = date, y = vol_sensor_cm3, color = "tree 1", linetype = burn_status), linewidth = 1, alpha = 0.7) + 
  geom_line(data = transb_col_tree2_abla, aes(x = date, y = vol_tree_cm3, color = "tree 2", linetype = burn_status), linewidth = 1, alpha = 0.7) + 
  geom_line(data = transb_col_tree3_abla, aes(x = date, y = vol_tree_cm3, color = "tree 3", linetype = burn_status), linewidth = 1, alpha = 0.7) +
  geom_line(data = transb_col_tree4_abla, aes(x = date, y = vol_tree_cm3, color = "tree 4", linetype = burn_status), linewidth = 1, alpha = 0.7) +
  facet_wrap(~ tree_id, nrow = 1, ncol = 4) +  # Separate by tree_id
  labs(
