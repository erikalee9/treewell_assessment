...
persb_vol_SWE_fullseason_lineplot <- ggplot() + 
  ...
  geom_line(data = fullseason_vol_persb, aes(x = date, y = vol_sensor_m3, color = "open canopy", linetype = "open canopy"), linewidth = 1, alpha = 0.8) + 
...
persb_vol_SWE_abla_lineplot <- ggplot() +
  geom_line(data = vol_persb_corr_data_abla, aes(x = date, y = vol_sensor_m3, color = "open canopy", linetype = "open canopy"), linewidth = 1, alpha = 0.8) + 
...
transb_vol_SWE_fullseason_lineplot <- ggplot() + 
  ...
  geom_line(data = fullseason_vol_transb, aes(x = date, y = vol_sensor_m3, color = "open canopy", linetype = "open canopy"), linewidth = 1, alpha = 0.8) + 
...
transb_vol_SWE_abla_lineplot <- ggplot() +
  geom_line(data = vol_transb_corr_data_abla, aes(x = date, y = vol_sensor_m3, color = "open canopy", linetype = "open canopy"), linewidth = 1, alpha = 0.8) + 
