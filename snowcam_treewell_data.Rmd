...
persb_SWE_fullseason_lineplot_V2 <- ggplot() + 
  # Line denoting ablation season
  geom_vline(xintercept = as.Date('2024-05-06'), color = "grey23", linetype = "dashed", linewidth = 0.6, alpha = 0.7) +
  geom_line(data = SWEonly_fullseason_vol_persb_V2, aes(x = date, y = SWE_sensor_cm, color = "open area", linetype = "open area"), linewidth = 0.8, alpha = 0.8) + 
  geom_line(data = persb_SWE_tree1_V2, aes(x = date, y = SWE_tree_cm, color = "tree 1", linetype = "tree 1"), linewidth = 0.8, alpha = 0.8) + 
  geom_line(data = persb_SWE_tree2_V2, aes(x = date, y = SWE_tree_cm, color = "tree 2", linetype = "tree 2"), linewidth = 0.8, alpha = 0.8) + 
  geom_line(data = persb_SWE_tree3_V2, aes(x = date, y = SWE_tree_cm, color = "tree 3", linetype = "tree 3"), linewidth = 0.8, alpha = 0.8) +
  geom_line(data = persb_SWE_tree4_V2, aes(x = date, y = SWE_tree_cm, color = "tree 4", linetype = "tree 4"), linewidth = 0.8, alpha = 0.8) +  
  facet_wrap(~ tree_id, nrow = 1, ncol = 4) +  
  labs(
    title = "a) PSZ",
    x = NULL,
